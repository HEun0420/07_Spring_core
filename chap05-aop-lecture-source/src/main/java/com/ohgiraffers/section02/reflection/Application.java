...
public class Application {
    public static void main(String[] args) {
         ...
         * 리플렉션의 주의사항
         *
         * 1. 오버헤드 발생 : 성능저하를 발생시킬 수 있다. 성능에 민감한 어플리케이션의 경우 사용하지 않는다.
         * 2. 캡슐화를 저해 : private로 설정한 member에 접근 가능하게 떄문에 코드 기능이 저하되며 여러가지 문제 야기
         */
        ...
        try {
            // Class.forname() 메소드를 이용해 런타임시 로딩을 하고 그 클래ㅐ스 메타정보를
            // Class 타입으로 받을 수 있다.
            ...
            Class class5 = double[].class; // 위와 같은 결과값임. 저게 이거랑 같음.

            System.out.println("class4 : " + class4);
            System.out.println("class5 : " + class5);

            System.out.println("=============== String 자료형 배열 클래스 ================");
            Class class6 = Class.forName("[Ljava.lang.String;"); // 문자열 배열 타
            ...
            // Account 부모타입
            System.out.println("=============== Account 자료형 배열 클래스 ================");
        ...
        for(Field field : fields){
            System.out.println("modifiers = " + Modifier.toString(field.getModifiers())); // 접근자
            System.out.println("type = " + field.getType()); // 타입
            System.out.println("modifiers = " + field.getName()); // 변수명
        }
