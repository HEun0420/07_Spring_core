...
public class Application {
    public static void main(String[] args) {
        ...
        *
        * singleton         하나의 인스턴스만을 생성하고, 모든 빈이 해당 인스턴스를 공유하고 사용한다.
        * prototype         매년 새로운 인스턴스를 생성한다.
        * request           HTTP 요청을 처리할 때마다 새로운 인스턴스를 생성하고,
        *                   요청처리가 끝나면 인스턴스를 폐기한다. 웹 어플리케이션 컨텍스느에만 해당한다.
        * session           HTTP 세션당 하나의 인스턴스를 생성하고
        *                   세션이 종료되면 인스턴스를 폐기한다. 웹어플리케이션 컨텍스트에만 해당한다.
        * globalSession     전역 세션당 하나의 인스턴스를 생성하고
        *                   전역 세션이 종료되면 인스턴스를 폐기한다. 포털 어플리케이션 컨텍스트에만 해당된다.
        ...
        // 담긴 내용 확인
        System.out.println("cart2에 담긴 내용 :" + cart1.getItems());
